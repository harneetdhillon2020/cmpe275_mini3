import grpc
from proto import transfer_file_pb2
from proto import transfer_file_pb2_grpc
...
async def generate_file_chunks(file: UploadFile, filename: str, chunk_size=1024 * 1024):
    ...
    while True:
        ...
        if not chunk:
            break
        yield transfer_file_pb2.transferRequest(
            data=chunk,
...
# send .txt file 
# make grpc call to send the .txt file to 
@app.post("/upload-txt")
